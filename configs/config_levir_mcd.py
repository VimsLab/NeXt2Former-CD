...
C.log_dir = osp.abspath('log_original_8bs/log_LEVIR/' + 'log_' + C.dataset_name + '_' + backbone_str + '_' + C.decoder)
# C.log_dir = osp.abspath('log_final/log_LEVIR/' + 'log_' + C.dataset_name + '_' + C.backbone + '_' + 'divov3_test')
