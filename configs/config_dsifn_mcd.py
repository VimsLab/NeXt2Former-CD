...
C.root_folder = osp.join(os.environ.get('DATASETS_ROOT', './datasets'), 'DSIFN-CD-256')
C.A_format = '.png'
C.B_format = '.png'
C.gt_format = '.png'
C.is_test = False
...
C.log_dir = osp.abspath('log_original_64bs/log_DSIFN/' + 'log_' + C.dataset_name + '_' + backbone_str + '_' + C.decoder)
