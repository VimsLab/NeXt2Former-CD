...
class Evaluator(object):
    ...
    def run(self, model_path, model_indice, log_file, log_file_link):
        ...
        for model in models:
            ...
            if len(self.devices ) == 1:
                 result_line, mean_IoU, dice = self.single_process_evalutation()
            else:
                 result_line, mean_IoU, dice = self.multi_process_evaluation()
        ...
        return result_line, mean_IoU, dice
    ...
    def single_process_evalutation(self):
        ...
        result_line, mean_IoU, dice = self.compute_metric(all_results)
        logger.info(
